...
| [`010-native-kotlin-android-server.md`](010-native-kotlin-android-server.md) | active; maintainer review accepted | Replace Android's QuickJS/TypeScript runtime with one native Kotlin server and align the core desktop/Android feature contract |
