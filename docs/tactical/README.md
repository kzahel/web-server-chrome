...
| [`012-chromeos-crostini-fallback.md`](012-chromeos-crostini-fallback.md) | scoped; physical x86_64 feasibility proved, implementation open | Provide a verified mini-Rust Linux fallback for ChromeOS users without Google Play, with Launcher, shared-folder, and LAN-port guidance |
