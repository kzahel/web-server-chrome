...
| [`012-chromeos-crostini-fallback.md`](012-chromeos-crostini-fallback.md) | scoped; stopped-VM Launcher wake proved on physical x86_64, implementation open | Provide a verified mini-Rust Linux fallback for ChromeOS users without Google Play, with bundled extension setup/control, Launcher, shared-folder, and LAN-port guidance |
| [`013-retire-typescript-cli.md`](013-retire-typescript-cli.md) | planned; public website promotion removed, implementation cleanup not started | Retire the unpublished Node/TypeScript CLI and engine while preserving the internal Rust core development CLI |
