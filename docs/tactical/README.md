...
| [`018-cross-platform-ci-and-test-confidence.md`](018-cross-platform-ci-and-test-confidence.md) | implemented; local closeout passed, first hosted executions pending push/tag | Add hosted iOS coverage, shared HTTP conformance, product E2E, artifact inspection, cross-version fixtures, and advisory testbed evidence |
