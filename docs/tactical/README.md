...
| [`016-native-swift-ios-app.md`](016-native-swift-ios-app.md) | active plan; implementation not started | Build a standalone native SwiftUI/Swift iOS app and prove foreground serving over a real LAN through the physical-device testbed |
