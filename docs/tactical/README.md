...
| [`008-appimage-first-linux-distribution.md`](008-appimage-first-linux-distribution.md) | source candidate and local validation complete; signed release and site deployment pending | Make AppImage the verified per-user Linux default and repair its extension launch path |
