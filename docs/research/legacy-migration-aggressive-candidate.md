# Legacy Chrome App Migration: Aggressive Candidate

Status: **current unshipped candidate; policy undecided.** This document records
the February/March 2026 maximum-aggressiveness implementation currently present
under `legacy/`. Repository history does not prove that this exact source was
published to the Chrome Web Store, and the reminder cadence has not been
accepted or rejected.

Current state, policy, and next work live in
[`../topics/legacy-app-migration.md`](../topics/legacy-app-migration.md) and
