...
| [`018-cross-platform-ci-and-test-confidence.md`](018-cross-platform-ci-and-test-confidence.md) | planned implementation; policy boundaries accepted | Add hosted iOS coverage, shared HTTP conformance, product E2E, artifact inspection, cross-version fixtures, and advisory testbed evidence |
